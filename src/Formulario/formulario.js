...
// Componente funcional Formulário, responsável pela edição de detalhes de um agente
function Formulario() {
...
// Exportação do componente Formulário
